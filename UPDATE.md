...
- 展示报告内容不再附带每条的更新时间等内部元数据（updatedAt/createdAt），仅日期+正文；用户明确询问时才提供

## v0.3.9

- 优化周报汇总流程：已有周报时同屏展示新旧周报供对比，确认后覆盖；无周报直接展示草稿并保存
- Response Style 新增"不暴露过程噪音"：工具报错与 Agent 自我修正独白不进回复
